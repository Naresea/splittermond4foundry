...
export class PortraitSheet {
  ...
  public static activatePortraitListener(
    htmlElem: JQuery<HTMLElement> | HTMLElement,
    ...
    html.on("click", ".portrait > .portrait-move-icon", (evt) => {
      ...
      switch (dataMove) {
        ...
        case "zoomIn":
          portraitListener.savePortraitTransform(
            PortraitSheet.scale(portraitListener, PortraitSheet.zoomSpeed)
          );
          break;
        case "zoomOut":
          portraitListener.savePortraitTransform(
