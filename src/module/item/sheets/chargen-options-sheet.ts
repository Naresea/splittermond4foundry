...
export class ChargenOptionsSheet extends FormApplication<ChargenOption> {
    ...
    protected _updateObject(
        ...
        this.object.skillTypeFilter = formData.skillTypeFilter ?? this.object.skillTypeFilter;
        this.object.masterySkillFilter = formData.masterySkillFilter ?? this.object.masterySkillFilter;
