...
export class DiceRollDialog extends FormApplication<DiceRollOption> {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            template: 'systems/splittermond/templates/sheets/popups/dice-roll-dialog.hbs',
            width: 512,
            height: 340,
    ...
    constructor(object?: DiceRollOption, options?: FormApplication.Options, submit?: (formData: any) => Promise<any>) {
