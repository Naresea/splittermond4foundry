...
export class SplimoCombat extends Combat {
    ...
    public async changeIniForCombatant(combatant: any, iniModifier?: number): Promise<void> {
        if (iniModifier != null) {
    ...
    public async changeIniForCombatants(combatant: Array<any>, iniModifier?: number): Promise<void> {
        if (iniModifier != null) {
            combatant.forEach(c => {
